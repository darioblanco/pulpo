...
│   │   │   ├── knowledge.rs      # Knowledge query endpoints
...
│   │   │   ├── manager.rs        # Orchestration (spawn, kill, resume, knowledge extraction)
│   │   │   └── pty_bridge.rs     # PTY bridge for WebSocket streaming
│   │   ├── store/                # Persistence
│   │   │   └── mod.rs            # SQLite store + migrations (sessions + knowledge)
...
│       ├── knowledge.rs          # Knowledge and KnowledgeKind types
